...
**Repository**: https://github.com/stereon/equity_capital_analysis/issues
...
```bash
gh issue view <issue_number> --repo stereon/equity_capital_analysis
gh issue view <issue_number> --repo stereon/equity_capital_analysis --comments
```
