...
**Repository**: https://github.com/stereon/equity_capital_analysis/pulls
...
```bash
gh pr view <pr_number> --repo stereon/equity_capital_analysis
gh pr view <pr_number> --repo stereon/equity_capital_analysis --comments
gh pr checks <pr_number> --repo stereon/equity_capital_analysis
gh pr diff <pr_number> --repo stereon/equity_capital_analysis
```
